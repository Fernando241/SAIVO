        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <nav id="menu">
                    ...
                    <a href="{{ route('productos.create') }}" class="nav_menu {{ request()->is('productos') ? 'active' : '' }}">Productos</a>
                    <a href="{{ url('/recetas') }}" class="nav_menu {{ request()->is('recetas') ? 'active' : '' }}">Contabilidad</a>
                </nav><br>
    
                <div class="container">
                    @livewire('products-create',['title' => 'Estoy dentro de la vista create de productos'])
                </div>
            </div>
        </div>
    </x-app-layout>
